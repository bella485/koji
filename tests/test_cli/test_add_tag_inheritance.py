...
import koji
from koji_cli.commands.add_tag_inheritance import handle_add_tag_inheritance
from . import utils
...
class TestAddTagInheritance(utils.CliTestCase):
    def setUp(self):
        ...
        self.activate_session_mock = mock.patch('koji_cli.commands.add_tag_inheritance.activate_session').start()
