...
import koji
from koji_cli.commands.edit_tag_inheritance import handle_edit_tag_inheritance
from . import utils
...
class TestEditTagInheritance(utils.CliTestCase):
    def setUp(self):
        ...
        self.activate_session_mock = mock.patch('koji_cli.commands.edit_tag_inheritance.activate_session').start()
